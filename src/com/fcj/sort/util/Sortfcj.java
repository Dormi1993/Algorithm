...
//            swap(s[right], s[center]);
    ...
    /*
    //新快排
    public static int adjust(int[] arrs, int l , int r){
        int i = l;
        int j = r;
        int x = arrs[i];
    ...
    public static void quickha(int[] arrs, int l, int r){

        if (l < r){
            int index = adjust(arrs, l, r);
            quickha(arrs, l, index - 1);
            quickha(arrs, index + 1, r);
        }
    }*/
